...
<?php } ?>
 ...
 <b>Data Kelahiran</b>
              ...
              ?>
                 ...
                 <?php $tampil=$conn->query("SELECT * from data_penduduk where ket='hidup' and asal='asli' ");
                             $user=mysqli_num_rows($tampil);
                    ?>
                                   
                  <center><h4>Jumlah Kelahiran : <?php echo "$user"; ?> Orang </h4> 

                    <div class="text-right" style="margin-top: 10px;">
                    <form action="laporan-kelahiran.php" method="POST">
                 ...
                 <a class="btn btn-sm btn-success glyphicon glyphicon-print"><input type="submit" class="btn btn-sm btn-success" value="Laporan" title="Laporan Kelahiran"></a><br><br>
                 <a href="input-kelahiran.php" class="btn btn-sm btn-primary">Tambah data kelahiran<i class="fa fa-arrow-circle-down"></i></a></form>
                </div>
