...
<?php } ?>
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and  jk = 'P' and YEAR(curdate()) - YEAR(tgl_lahir) >= '6' and YEAR(curdate()) - YEAR(tgl_lahir) <= '11' ");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Kanak-Kanak Wanita : <?php echo "$user"; ?> Orang </h4> </center>
