...
<h2><center>Laporan log aktivitass</center></h2>
                             <?php
                          ...
                          if ($bln_create=="all") {
                            $query1="SELECT * from log_aktivitas where YEAR(waktu)='$thn_create'";
                              # code...
                          }
                          else{
                            $query1="SELECT * from log_aktivitas where YEAR(waktu)='$thn_create' and MONTH(waktu)='$bln_create'";
                          }
