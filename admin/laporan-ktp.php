...
<title>Surat Rekomendasi KTP</title>
</head>
...
<h2><center>Surat Rekomendasi Pembuatan KTP</center></h2>
                          <?php
                          //$id = "SELECT * FROM data_penduduk "
                    $query1="SELECT * from data_penduduk where nik='$_GET[kd]'";
$no=0;
                    $tampil=$conn->query($query1) or die(mysql_error());
                    $kampung = "SELECT * FROM profil_desa";
                    $tampilkampung=$conn->query($kampung) or die(mysql_error());
                    $datakampung=mysqli_fetch_array($tampilkampung);
                    $data=mysqli_fetch_array($tampil);

                    define('HOST_NAME', 'localhost');
                    define('DB_NAME', 'sisfo');
                    define('USER_NAME', 'root');
                    define('PASS', '');
                    
                    $con = mysqli_connect(HOST_NAME, USER_NAME, PASS, DB_NAME);
                    $tanggalan = mysqli_query($con, "SELECT tgl_lahir FROM data_penduduk where nik='$_GET[kd]'");
                    $row = mysqli_fetch_assoc($tanggalan);
                    $tanggalin = $row["tgl_lahir"];

                    //$tgl = "SELECT tgl_lahir FROM data_penduduk where id='$_GET[kd]'";
                    //$row = mysqli_fetch_array($tgl);
                    //$tanggal = $tgl["tgl_lahir"];
                    ?>
        Yang bertanda tangan di bawah ini Kepala Desa/Lurah <?php echo $datakampung['desa']; ?> Kecamatan <?php echo $datakampung['kecamatan']; ?> Kabupaten <?php echo $datakampung['kabupaten']; ?> menerangkan bahwa : <br><br>

                   <table>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspNIK</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['nik']; ?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspNama</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['nama']; ?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspTempat, Tanggal Lahir</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['tempat_lahir'];?>, <?php echo date("d F Y", strtotime($tanggalin)); ?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspJenis Kelamin</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['jk'];?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspAgama</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['agama']; ?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspPekerjaan</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['pekerjaan']; ?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspStatus Perkawinan</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['status']; ?></h4></td>
                     </tr>
                     <tr>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbspKewarganegaraan</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp:</h4></td>
                      <td><h4>&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $data['kewarganegaraan']; ?></h4></td>
                     </tr>
                     
                </table>
        Memang benar yang namanya tersebut diatas Penduduk dan Berdomisili di Desa/Kelurahan <?php echo $datakampung['desa']; ?> Kecamatan <?php echo $datakampung['kecamatan']; ?> Kabupaten <?php echo $datakampung['kabupaten']; ?><br>
        Surat Pengantar ini diberikan untuk keperluan mengurus/mengambil : 
        <b> KTP </b><br><br>
        Demikianlah Surat Pengantar ini dibuat dengan sebenarnya, untuk dapat dipergunakan sebagaimana mestinya.<br><br>
<?php } ?>
<table  align="right">
    <tr>
        <td></td>
        <td></td>
        <td><center>Kepala Desa <?php echo $datakampung['desa']; ?><center></td>
    </tr>
    <tr></tr>
    <tr></tr>
    <tr>
