...
<h2><center>Laporan Data Kelahiran</center></h2>
                          <?php
                          ...
                          if ($bln_create=="all") {
                            $query1="SELECT * from data_penduduk where asal = 'asli' and ket = 'hidup' and YEAR(tgl_create)='$thn_create'";
                              # code...
                          }
                          else{
                            $query1="SELECT * from data_penduduk where asal = 'asli' and ket = 'hidup' and YEAR(tgl_create)='$thn_create' and MONTH(tgl_create)='$bln_create'";
                          }
