...
<head>
    <meta charset="UTF-8">
    <title>Input Data Migrasi</title>
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-migrasi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">ID</label>
                              <div class="col-sm-8">
                                  <input name="id_migrasi" type="text" id="id_migrasi" class="form-control" placeholder="Tidak perlu di isi" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="tanggal_lahir" type="date" id="tanggal_lahir" class="form-control" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          ...
                          <!-- <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kewarganegaraan</label>
                              <div class="col-sm-8">
                                  <input name="kewarganegaraan" class="form-control" id="kewarganegaraan" type="text" placeholder="Kewarganegaraan" required />
                              </div>
                          </div> -->
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="no_kk" class="typeahead form-control" id="kk" type="text" placeholder="nomor kk" required autocomplete="off" />
                              </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="tgl_masuk" class="form-control" id="tgl_masuk" type="date" placeholder="tanggal masuk" required />
                              </div>
                          </div>
                          <br>
                          <h3><b><center>Alamat Asal</center></b></h3>

                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Alamat</label>
                              <div class="col-sm-7">
                                  <input name="alamat_asal" class="form-control" id="alamat_asal" type="text" placeholder="Alamat" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">RT/RW</label>
                              <div class="col-sm-7">
                                  <input name="rtrw_asal" class="form-control" id="rtrw_asal" type="text" placeholder="00/00" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Desa/Kel</label>
                              <div class="col-sm-7">
                                  <input name="desa_asal" class="form-control" id="desa_asal" type="text" placeholder="Desa/Kel" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Kecamatan</label>
                              <div class="col-sm-7">
                                  <input name="kecamatan_asal" class="form-control" id="kecamatan_asal" type="text" placeholder="Kecamatan" required />
                              </div>
                              </div>
                                <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Kabupaten/Kota</label>
                              <div class="col-sm-7">
                                  <input name="kabupaten_asal" class="form-control" id="kabupaten_asal" type="text" placeholder="Kabupaten" required />
                              </div>
                              </div>
                                <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Provinsi</label>
                              <div class="col-sm-7">
                                  <input name="provinsi_asal" class="form-control" id="provinsi_asal" type="text" placeholder="Provinsi" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Kode Pos</label>
                              <div class="col-sm-7">
                                  <input name="kodepos_asal" class="form-control" id="kodepos_asal" type="text" placeholder="Kode Pos" required />
                              </div>
                              </div>
                              <br>
                              ...
                              <label class="col-sm-3 col-sm-3 control-label">Alamat</label>
                              <div class="col-sm-7">
                                  <input name="alamat_domisili" class="form-control" id="alamat_domisili" type="text" placeholder="Alamat" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">RT/RW</label>
                              <div class="col-sm-7">
                                  <input name="rtrw_domisili" class="form-control" id="rtrw_domisili" type="text" placeholder="00/00" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Desa/Kel</label>
                              <div class="col-sm-7">
                                  <input name="desa_domisili" class="form-control" id="desa_domisili" type="text" placeholder="Desa/Kel" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Kecamatan</label>
                              <div class="col-sm-7">
                                  <input name="kecamatan_domisili" class="form-control" id="kecamatan_domisili" type="text" placeholder="Kecamatan" required />
                              </div>
                              </div>
                                <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Kabupaten</label>
                              <div class="col-sm-7">
                                  <input name="kabupaten_domisili" class="form-control" id="kabupaten_domisili" type="text" placeholder="Kabupaten" required />
                              </div>
                              </div>
                                <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Provinsi</label>
                              <div class="col-sm-7">
                                  <input name="provinsi_domisili" class="form-control" id="provinsi_domisili" type="text" placeholder="Provinsi" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Kode Pos</label>
                              <div class="col-sm-7">
                                  <input name="kodepos_domisili" class="form-control" id="kodepos_domisili" type="text" placeholder="Kode Pos" required />
                              </div>
                              </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
                                ...
                                <a href="datamigrasi.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
