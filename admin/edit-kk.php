...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-kk.php?kd=<?php echo $data['nik']; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                     <div class="form-group">
                          ...
                          <?php  $sql = $conn->query("SELECT * FROM data_penduduk WHERE nik='$nik'");
                    ...
                    ?>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="jenis_pekerjaan" class="form-control" id="jenis_pekerjaan" type="text" value="<?php echo $dataa['pekerjaan']; ?>" required />
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Status</label>
                              <div class="col-sm-4">
                                  <select class="form-control" name="status_pernikahan" value="<?php echo $dataa['status']; ?>" id="status_pernikahan">
                                  <option> <?php echo $dataa['status']; ?></option>
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <select class="form-control" name="status_keluarga" value="<?php echo $dataa['status_keluarga']; ?>" id="status_keluarga">
                                  <option> <?php echo $dataa['status_keluarga']; ?></option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="no_paspor" class="form-control" id="paspor" type="text" value="<?php echo $dataa['no_paspor']; ?>" placeholder="isi (-) jika tidak ada" required />
                              </div>
                          </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Kitaskitap</label>
                              <div class="col-sm-8">
                                  <input name="no_kitaskitap" class="form-control" id="kitas" type="text" value="<?php echo $dataa['no_kitaskitap']; ?>" placeholder="isi (-) jika tidak ada" required />
                              </div>
                          </div>
                          ...
                          <div class="box-header"> 
                              ...
                              <div class="col-sm-8">
                                  <input name="ayah" class="form-control" id="ayah" type="text" value="<?php echo $dataa['nama_ayah']; ?>" required />
                              </div>
                          </div><div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pekerjaan Ayah</label>
                              <div class="col-sm-8">
                                  <input name="pekerjaan_ayah" class="form-control" id="pekerjaan_ayah" type="text" value="<?php echo $dataa['pekerjaan_ayah']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Ibu</label>
                              <div class="col-sm-8">
                                  <input name="ibu" class="form-control" id="bu" type="text" value="<?php echo $dataa['nama_ibu']; ?>" required />
                              </div>
                          </div>
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pekerjaan Ibu</label>
                              <div class="col-sm-8">
                                  <input name="pekerjaan_ibu" class="form-control" id="pekerjaan_ibu" type="text" value="<?php echo $dataa['pekerjaan_ibu']; ?>" required />
                              </div>
                          </div>
