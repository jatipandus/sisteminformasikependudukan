...
<head>
    ...
    <meta name="keywords" content="Sistem Indformasi Kependudukan">
    <!-- bootstrap 3.0.2 -->
	...
	<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = $conn->query("SELECT * FROM admin WHERE user_id='$_GET[kd]'");
                    $data  = mysqli_fetch_array($query);
                    ?>
                                <!-- </div> -->
                                <div class="panel-body">
                      <form class="form-horizontal style-form" action="update-admin.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="username" type="text" id="username" class="form-control" title="Username Tidak Bisa Diubah" readonly="on" value="<?php echo $data['username'];?>" required />
                          ...
                          <div class="form-group">
                              ...
                              <b>Dekrip password</b> <a href="https://www.md5online.org/md5-decrypt.html" target="_blank">Disini</a>
                              </div>
                          </div>
                          <?php 
                          $siapa= $data['fullname'];
                          if ($siapa=='superadmin') { ?>
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name="fullname" class="form-control" id="fullname" type="text" value="<?php echo $data['fullname'];?>" readonly/>
                              </div>
                          </div>
                          <?php
                        }else{ ?>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Fullname</label>
                              <div class="col-sm-10">
                                  <input name="fullname" class="form-control" id="fullname" type="text" value="<?php echo $data['fullname'];?>"/>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <img src="<?php echo $data['gambar'];?>" height="150" width="150" class="img-circle" style="border: 3px solid orange;"/>
                                    <input type="file" class="form-control" id="nama_file" value="<?php echo $data['gambar']; ?>" name="nama_file"  >
                              </div>
                          </div>
                          <div class="form-group">
