...
<table style='margin-left:2cm'>
	...
	<tr>
		<td>Alamat</td>
		<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</td>
		<td><br><?php echo $data['alamat']?>, RT/RW <?php echo $data['rtrw']?>, Desa <?php echo $data['desa']?>, Kecamatan <?php echo $data['kecamatan']?></td>
	</tr>
	<?php
		}
	?>
...
<table  align="right" width="100%">
	<tr>
		<td></td>
		<td></td>
		<td width="20%"><center>Kepala Desa<center></td><br><br>
	</tr>
	<tr></tr>
	<tr></tr>
	<tr>
...
<tr>
	<td align="left"><font size="1" >admin : <?php echo $admin; ?></td>
</tr>
