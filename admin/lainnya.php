...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Yang Beragama Lain-Lain</title>
...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Data Penduduk Yang Beragama Lain-Lain</b>
                    ...
                    $query1="SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and agama != 'budha' and agama != 'katolik' and agama != 'protestan' and agama != 'islam' and agama != 'konghuchu' and agama != 'hindu' " ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and agama != 'budha' and agama != 'katolik' and agama != 'protestan' and agama != 'islam' and agama != 'konghuchu' and agama != 'hindu' ");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Penduduk Yang Beragama Lain-Lain : <?php echo "$user"; ?> Orang </h4> </center>
