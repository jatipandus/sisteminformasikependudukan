...
<?php } ?>
                ...
                <section class="content">
                    ...
                    $query1="SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and agama = 'islam'" ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal !='pergi' and agama = 'islam'");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Penduduk Yang Beragama Islam : <?php echo "$user"; ?> Orang </h4> </center>
