...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                  <b>Rekomendasi Membuat KTP (kartu tanda penduduk)</b>
                                ...
                                <div class="panel-body table-responsive">
                                                                    <!-- PANGGAH - INI DIHAPUS ATAU DIJADIKAN KOMENTAR  -->
                                        ...
                                        <input type='text' class="form-control input-sm pull-right" style="width: 150px;"  name='qcari' placeholder='Cari berdasarkan User ID dan Username' required />
                                            <div class="input-group-btn">
                                                <button class="btn btn-sm btn-default" type="submit"><i class="fa fa-search"></i></button>
                                                                        ...
                                                                        <!-- SAMPAI SINI  --> <!-- $query1="select * from data_penduduk where ket = 'hidup' and asal !='pergi' ";-->
                                    <?php
                  ...
                  <thead>
                    ...
                    <td><?php echo $no ?></td>    
                    <td> <a href="detail-ktp.php?hal=edit&kd=<?php echo $data['nik'];?>"><?php echo $data['nik']; ?></a></td>
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and YEAR(curdate()) - YEAR(tgl_lahir)='17' and MONTH(tgl_lahir) = MONTH(curdate()) and DAY(tgl_lahir) <= DAY(curdate())  " );
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Penduduk Berusia 17 tahun : <?php echo "$user"; ?> Orang </h4> </center><br />
                         
            <div class="text-right">
                 <a href="lapor-ktp.php" class="btn btn-sm btn-success" ><span class="glyphicon glyphicon-print">  Laporan</a><br><br>
                </div>
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="#" target="_blank">Newbie</a> 2017
                </div>
            </aside><!-- /.right-side -->
