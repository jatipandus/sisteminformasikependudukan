...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Yang Beragama Budha</title>
...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Data Penduduk Yang Beragama Budha</b>
                    ...
                    $query1="SELECT id,nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and agama = 'budha'  and jk = 'P'" ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and agama = 'budha' and jk = 'P'");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Wanita Yang Beragama Budha : <?php echo "$user"; ?> Orang </h4> </center>
