...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <td rowspan="9"><div >
                        <center>
                            <img src="<?php echo $data['gambar']; ?>" class="img-rounded" height="200" width="200" alt="User Image" style="border: 3px solid #333333;" />
                        </center></div></td>
                    </tr>
                    <tr>
                ...
                <div class="text-right">
                 <a href="dataadmin.php" class="btn btn-sm btn-primary"> Kembali <i class="fa fa-arrow-circle-left"></i></a>
