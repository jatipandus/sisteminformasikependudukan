...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-update-kematian.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <input type="hidden" name="id_penduduk" value="<?php echo $_GET['kd']; ?>">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Meninggal</label>
                              <div class="col-sm-8">
                                  <input name="tgl_mati" type="date" id="tgl_mati" class="form-control" placeholder="Tanggal Meninggal" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tempat Pemakaman</label>
                              <div class="col-sm-8">
                                  <input name="tmpt_makam" type="text" id="tmpt_makam" class="form-control" placeholder="Tempat Pemakaman" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nik_pelapor" type="text" id="nik_pelapor" class="form-control" placeholder="NIK Pelapor" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="hubungan_pelapor" type="text" id="hubungan_pelapor" class="form-control" placeholder="Hubungan Pelapor" required />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                           ...
                           <?php
                           $temp=$_GET['kd'];
                            $query = $conn->query("SELECT * FROM data_penduduk WHERE id='$temp'");
                            $data  = mysqli_fetch_array($query);
                          ?>
                          <div class="form-group">
                              <!-- <label class="col-sm-2 col-sm-2 control-label">Keterangan Baru</label> -->
                              <input type="hidden" name="ket" value="mati">
                              <!-- <div class="col-sm-4">
                                  <select class="form-control" name="ket" id="ket">
                                  <option> <?php echo $data['ket']; ?></option>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
                                ...
                                <a href="input-penduduk.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
