...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Dewasa</title>
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    $query1="SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and  YEAR(curdate()) - YEAR(tgl_lahir) >= '26' and YEAR(curdate()) - YEAR(tgl_lahir) <= '45'" ;
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and YEAR(curdate()) - YEAR(tgl_lahir) >= '26' and YEAR(curdate()) - YEAR(tgl_lahir) <= '45' ");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Penduduk Dewasa : <?php echo "$user"; ?> Orang </h4> </center>
