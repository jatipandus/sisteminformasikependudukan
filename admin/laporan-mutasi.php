...
<h2><center>Laporan Data Mutasi</center></h2>
                          <?php
                          ...
                          if ($bln_create=="all") {
                            $query1="SELECT * from data_mutasi where YEAR(tgl_create)='$thn_create'";
                              # code...
                          }
                          else{
                            $query1="SELECT * from data_mutasi where YEAR(tgl_create)='$thn_create' and MONTH(tgl_create)='$bln_create'";
                          }
$no=0;
                  ...
                  <thead>
                    ...
                    <td>RT/RW <?php echo $data['rtrw_mutasi']?>, Desa <?php echo $data['desa_mutasi']?>, 
                        Kecamatan <?php echo $data['kecamatan_mutasi']?>, Kabupaten <?php echo $data['kabupaten_mutasi']?></td>
