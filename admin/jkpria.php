...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Pria</title>
...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Data Penduduk Yang Berjenis Kelamin Pria</b>
                    ...
                    $query1="SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal != 'pergi' and jk = 'laki-laki' " ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk  where  ket = 'hidup' and asal != 'pergi' and jk = 'laki-laki'");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Penduduk Berjenis Kelamin Pria : <?php echo "$user"; ?> Orang </h4> </center>
