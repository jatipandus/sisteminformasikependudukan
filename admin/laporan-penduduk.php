...
<title>Laporan Penduduk</title>
<h2><center>Laporan Data Penduduk</center></h2>
                          <?php
                          ...
                          if ($bln_create=="all") {
                            $query1="SELECT * from data_penduduk where YEAR(tgl_create)='$thn_create' and ket = 'hidup' and asal != 'pergi'";
                              # code...
                          }
                          else{
                            $query1="SELECT * from data_penduduk where YEAR(tgl_create)='$thn_create' and MONTH(tgl_create)='$bln_create' and ket = 'hidup' and asal != 'pergi'";
                          }
