                        ...
                        <!-- User Account: style can be found in dropdown.less -->
                         <li >
                            <a href="notif_buat_ktp.php">
                                 <?php $tampil=$conn->query("SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, 
                                    YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and YEAR(curdate()) - YEAR(tgl_lahir)='17' and MONTH(tgl_lahir) = MONTH(curdate()) and DAY(tgl_lahir) <= DAY(curdate())  " );
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    $query1="SELECT nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia 
                    FROM data_penduduk where ket = 'hidup' and asal !='pergi'" ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi'");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Penduduk : <?php echo "$user"; ?> Orang </h4> </center> 


                <div class="text-right" style="margin-top: 10px;">
                    <form action="laporan-penduduk.php" method="POST">
                 ...
                 <a href="laporan-penduduk.php" class="btn btn-sm btn-success"><span class=" glyphicon glyphicon-print"></span><input type="submit" class="btn btn-sm btn-success" value="Laporan" title="Laporan Penduduk"></a><br><br>
                 <a href="input-penduduk.php" class="btn btn-sm btn-primary">Tambah data Penduduk<i class="fa fa-arrow-circle-down"></i></a></form>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
