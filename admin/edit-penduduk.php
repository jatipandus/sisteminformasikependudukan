...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-penduduk.php?kd=<?php echo $_GET['kd']; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <input name="kabupatenkota" class="form-control" value="<?php echo $data['kabupatenkota']; ?>" id="kabupatenkota" type="text" placeholder="Kabupaten/Kota" required />
                              </div>
                              </div>
                              <div class="form-group">
