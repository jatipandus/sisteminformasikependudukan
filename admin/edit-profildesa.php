...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Edit Profil Desa</b>

                                </header>
                                <!-- <div class="box-header"> -->
                                    <!-- <h3 class="box-title">Responsive Hover Table</h3> -->
                    <?php
                    $query = $conn->query("SELECT * FROM profil_desa WHERE id='$_GET[id]'");
                    ...
                    ?>
                                ...
                                <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-profildesa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">id</label>
                              <div class="col-sm-8">
                                  <input name="id" type="text" id="id" class="form-control" value="<?php echo $data['id']; ?>" required readonly/>
                     ...
                     <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kepaladesa" type="text" id="kepaladesa" class="form-control" value="<?php echo $data['kepaladesa']; ?>" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kabupaten" type="text" id="kabupaten" class="form-control" value="<?php echo $data['kabupaten']; ?>"  required />
                              </div>
                          </div>
                          <div class="form-group">
