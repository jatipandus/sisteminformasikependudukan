...
<?php } ?>
                ...
                <section class="content">
                   ...
                   $tampil=$conn->query("SELECT * from data_mutasi ");
                  ...
                  <thead>
                    ...
                    <tr>
                        <td><?php echo $no ?></td> 
                    <td> <a href="detail-mutasi.php?hal=edit&kd=<?php echo $data['nik'];?>"><?php echo $data['nik']; ?></a></td>
                    <td><?php echo $data['nama'];?></td>
                    <td><?php echo $data['tanggal_keluar'];?></td>
                    <td>RT/RW <?php echo $data['rtrw_mutasi']?>, Desa <?php echo $data['desa_mutasi']?>, Kecamatan <?php echo $data['kecamatan_mutasi']?>, Kabupaten <?php echo $data['kabupaten_mutasi']?>, Provinsi <?php echo $data['provinsi_mutasi']?></td>
                     ...
                     <?php $tampil=$conn->query("SELECT * from data_mutasi ");
                             $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Mutasi : <?php echo $user; ?> Orang </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                    <form action="laporan-mutasi.php" method="POST">
                 ...
                 <a class="btn btn-sm btn-success glyphicon glyphicon-print"><input type="submit" class="btn btn-sm btn-success" value="Laporan" title="Laporan Mutasi"></a><br><br>
                 <a href="input-nik-mutasi.php" class="btn btn-sm btn-primary">Tambah data Mutasi<i class="fa fa-arrow-circle-down"></i></a>
             </form>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
