...
<head>
    ...
    <?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Detail Data Kematian</b>

                                </header>
                                <!-- <div class="box-header"> -->
                                    <!-- <h3 class="box-title">Responsive Hover Table</h3> -->
                    <?php
                    $query = $conn->query("SELECT * from data_penduduk, data_kematian where ket = 'mati' and id_kematian='$_GET[kd]'");
                    ...
                    <tr>
                    <td width="250">ID</td>
                    <td width="550"><?php echo $data['id_kematian']; ?></td>
                    </tr>
                    <tr>
                    <td>Tanggal Mati </td>
                    ...
                    <tr>
                    <td colspan="2"><b><h3><center>Detail Penduduk</center></h3></b></td>
                    </tr>
                    <tr>
                    <td width="250">NIK penduduk</td>
                    ...
                    <td width="550"><?php echo $data['tgl_lahir']; ?></td>
                    </tr>
                ...
                <div class="text-right">
                 <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="cetaksurat"  href="suratkematian.php?hal=edit&kd=<?php echo $data['id_kematian'];?>"><span class="glyphicon glyphicon-print"></span></a> 
                <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Edit data" href="edit-kematian.php?hal=edit&kd=<?php echo $data['id_kematian'];?>"><span class="glyphicon glyphicon-edit"></span></a>
                <a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="hapus data" href="hapus-kematian.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-trash"></span></a>
                 <br><br>

                <a href="datakematian.php" class="btn btn-sm btn-primary"> Kembali <i class="fa fa-arrow-circle-left"></i></a>
                </div>
                                </div>
                            </div><!-- /.box -->
                        </div>
