<?php
	include '../conn.php';
                    $query1="SELECT * FROM data_mutasi ";
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
    ...
    .0001pt;text-align:center;line-height:normal'><span style='font-size:15.0pt;
    mso-bidi-font-size:11.0pt;text-transform:uppercase;'><b>PEMERINTAH KABUPATEN YOGYAKARTA <?php echo $desa['kabupaten']; ?></b><o:p></o:p></span></p>
   
    <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:
    .0001pt;text-align:center;line-height:normal'><span style='font-size:13.0pt;
    mso-bidi-font-size:11.0pt;text-transform:uppercase;'><b>KECAMATAN UMBULHARJO  <?php echo $desa['kecamatan'];?></b></span></p>
    <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:
    .0001pt;text-align:center;line-height:normal'><span style='font-size:11.0pt;
    mso-bidi-font-size:11.0pt'><b>WARUNGBOTO</b></span></p>
    <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:
    .0001pt;text-align:center;line-height:normal'><span style='font-size:11.0pt;
    ...
    style='font-size:9.0pt;mso-bidi-font-size:9.0pt'><i>Jln.Umbul raya No.3 warungboto</i></span></p>
    </div>
    <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:
...
<br>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:
    ...
    mso-bidi-font-size:9.0pt'><b><u>SURAT PENGANTAR PINDAH DATANG PENDUDUK WNI</u></b></span></p>
...
<table style='margin-left:2cm'>
	...
	<tr>
		<td></td>
		<td></td>
		<td>RT/RW : <?php echo $data['rtrw_mutasi']?></td>
		<td>KEL/DESA &nbsp;: <?php echo $data['desa_mutasi']?></td>
		
	</tr>
	<tr>
		<td></td>
		<td></td>
		<td>KEC&nbsp&nbsp&nbsp&nbsp&nbsp: <?php echo $data['kecamatan_mutasi']?></td>
		<td>KAB/KOTA : <?php echo $data['kabupaten_mutasi']?></td>
	</tr>
...
<br>
<span style='margin-left:1cm'>Adapun permohonan pindah penduduk WNI yang bersangkutan sebagaimana terlampir</span>

<br>
<span style='margin-left:1cm'>Demikian surat pengantar pindah ini dibuat agar dapat dipergunakan sebagaimana mestinya</span>
...
<table  width="100%" >
	...
	<tr>
		<td align="center">KEPALA DESA</td><br>
	</tr>
	<tr><td><br></td></tr>
	<tr>
	
		<td><center><?php echo $desa['kepaladesa']; ?></center></td>
		
	</tr>


	<tr>
		<td><center><hr width="50%" size="1">NIP <?php echo $desa['NIP']; ?></center></td><br>
	</tr>
	<tr><td><br></td></tr>
	<tr>
