                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Input Data Mutasi</b>

                                </header>
                                
                                <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="input-mutasi.php" method="post" enctype="multipart/form-data" name="form1" id="form1"> 
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label ">NIK Penduduk</label>
                              <div class="col-sm-8">
                                  <input name="nik" class="typeahead form-control" id="nik" type="text" placeholder="NIK" autocomplete="off" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
                                  <input type="submit" value="Lihat Detail" class="btn btn-sm btn-primary" />&nbsp;
