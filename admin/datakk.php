...
<?php } ?>
 ...
 <b>Data Kartu Keluarga</b>
                  ...
                  <thead>
                    ...
                    <tr>
                     <td><?php echo $no ?></td>   
                    <td> <a href="detail-kk.php?hal=edit&kd=<?php echo $data['no_kk'];?>"><?php echo $data['no_kk']; ?></a></td>                 
                    <td><?php echo $data['nama_kepalakeluarga'];?></td>
                    <td><?php echo $data['alamat'];?></td>
                    <td><?php echo $data['rtrw'];?></td>
                     <td><?php echo $data['kodepos']; ?></td>
                    <td><?php echo $data['desakelurahan']; ?></td>
              ...
              ?>
                 ...
                 <?php $tampil=$conn->query("SELECT * from data_kk ");
                             $user=mysqli_num_rows($tampil);
                    ?>
                                   
                  <center><h4>Jumlah KK : <?php echo "$user"; ?> </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                 
                 <a href="input-kk.php" class="btn btn-sm btn-primary">Tambah data KK <i class="fa fa-arrow-circle-down"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
