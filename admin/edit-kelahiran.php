...
$tampil=$conn->query("SELECT * from data_penduduk where nik='$_GET[kd]' ");
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-kelahiran.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
													...
													<div class="form-group">
															...
															<div class="col-sm-7">
																	<input name="rtrw" class="form-control" id="rtrw" type="text" value="<?php echo $data['rtrw']; ?>" required />
															</div>
															</div>
															<div class="form-group">
															<label class="col-sm-3 col-sm-3 control-label">Desa/Kel</label>
															<div class="col-sm-7">
																	<input name="desa" class="form-control" id="desa" type="text" value="<?php echo $data['desa']; ?>" required />
															</div>
															</div>
															<div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <input name="kabupaten" class="form-control" id="kabupaten" type="text" value="<?php echo $data['kabupatenkota']; ?>" required />
                              </div>
                              </div>
                              <div class="form-group">
                              <label class="col-sm-3 col-sm-3 control-label">Provinsi</label>
                              <div class="col-sm-7">
                                  <input name="provinsi" class="form-control" id="provinsi" type="text" value="<?php echo $data['provinsi']; ?>" required />
                              </div>
                              </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <select class="form-control" name="kewarganegaraan" value="<?php echo $data['kewarganegaraan']; ?>" id="kewarganegaraan">
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                  <select class="form-control" name="asal" id="asal" value="<?php echo $data['asal']; ?>">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="nama_ibu" class="form-control" id="nama_ibu" type="text" value="<?php echo $data['nama_ibu']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pekerjaan Ibu</label>
                              <div class="col-sm-8">
                                  <input name="pekerjaan_ibu" class="form-control" id="pekerjaan_ibu" type="text" value="<?php echo $data['pekerjaan_ibu']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Ayah</label>
                              <div class="col-sm-8">
                                  <input name="nama_ayah" class="form-control" id="nama_ayah" type="text" value="<?php echo $data['nama_ayah']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pekerjaan Ayah</label>
                              <div class="col-sm-8">
                                  <input name="pekerjaan_ayah" class="form-control" id="pekerjaan_ayah" type="text" value="<?php echo $data['pekerjaan_ayah']; ?>" required />
                              </div>
                          </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="datakelahiran.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
