...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Yang Belum Kawin</title>
...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Data Penduduk Yang Belum Kawin</b>
                    ...
                    $query1="SELECT id,nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and status = 'belum_kawin' and jk = 'P'" ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and jk = 'P' and status = 'belum_kawin' ");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Wanita Yang Belum Kawin : <?php echo "$user"; ?> Orang </h4> </center>
