...
<head>
    ...
    <?php } ?>
                ...
                <br><br>
                <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Penduduk" 
                href="edit-penduduk.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-edit"></span></a>

                <a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="Hapus data" 
                href="hapus-penduduk.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-trash"></a><br><br>
