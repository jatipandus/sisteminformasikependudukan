...
<head>
    ...
    <?php } ?>
                ...
                <section class="content">
                    ...
                    <td> <a href="detail-kk.php?hal=edit&kd=<?php echo $data['nomor_kk'];?>"><?php echo $data['nomor_kk']; ?></a></td>
                ...
                <div class="text-right">
                     ...
                     <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip"  href="suratketlahir.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-print"></span></a>
                     <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Edit data" href="edit-kelahiran.php?hal=edit&kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-edit"></span></a>
                     <a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="Hapus data" href="hapus-kelahiran.php?kd=<?php echo $data['nik'];?>"><span class="glyphicon glyphicon-trash"></a><br><br>
                  


                <a href="datakelahiran.php" class="btn btn-sm btn-primary"> Kembali <i class="fa fa-arrow-circle-left"></i></a>
                </div>
                                </div>
                            </div><!-- /.box -->
                        </div>
