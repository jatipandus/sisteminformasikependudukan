...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-anggotakk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No KK</label>
                              <div class="col-sm-8">
                                  <input name="no_kk" class="form-control" id="no_kk" type="text" value="<?php echo $no_kk ?>" readonly />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <input name="provinsi" class="form-control" id="provinsi" type="text" placeholder="Provinsi" required />
                              </div>
                              </div>
