...
<h2><center>Laporan Data Kematian</center></h2>
                          <?php
                          $thn_create = $_POST['thn_create'];
                          $bln_create = $_POST['bln_create'];

                         
                    if ($bln_create=="all") {
                              # code...
                            $query1="SELECT data_penduduk.nama, data_penduduk.nik, data_kematian.tgl_mati, data_kematian.tmpt_makam, 
                    data_kematian.nama_pelapor, data_kematian.hubungan_pelapor, data_kematian.nik_pelapor, data_kematian.nik from data_penduduk, data_kematian where data_kematian.thn_create='$thn_create' and data_penduduk.asal = 'asli' and data_penduduk.ket = 'mati' and data_kematian.nik=data_penduduk.nik ";
                          }
                          else{
                    $query1="SELECT data_penduduk.nama, data_penduduk.nik, data_kematian.tgl_mati, data_kematian.tmpt_makam, 
                    data_kematian.nama_pelapor, data_kematian.hubungan_pelapor, data_kematian.nik_pelapor, data_kematian.nik from data_penduduk, data_kematian where data_kematian.thn_create='$thn_create' and data_kematian.bln_create='$bln_create' and data_penduduk.asal = 'asli' and data_penduduk.ket = 'mati' and data_kematian.nik=data_penduduk.nik";       
                         }
$no=0;
                  ...
                  <thead>
                      ...
                      <tr>
                        ...
                        <th><center>Tanggal Mati </center></th>
                        <th><center>Tempat Makam </center></th>
                        <th><center>Nama Pelapor </center></th>
                        <th><center>NIK Pelapor </center></th>
                        <th><center>Hubungan Pelapor </center></th>
                      </tr>
                  </thead>
                    ...
                    <td><center><?php echo $data['tgl_mati'];?></center></td>
                    <td><center><?php echo $data['tmpt_makam'];?></center></td>
                    <td><center><?php echo $data['nama_pelapor'];?></center></td>
                    <td><center><?php echo $data['nik_pelapor']; ?></center></td>
                    <td><center><?php echo $data['hubungan_pelapor']; ?></center></td>
