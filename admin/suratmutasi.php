...
session_start();
 $admin=$_SESSION['username'];
	include '../conn.php';
                    $query1="SELECT * FROM data_mutasi WHERE nik='$_GET[kd]'";
...
<br>
<span style='margin-left:2cm'>Adapun permohonan pindah penduduk WNI yang bersangkutan sebagaimana terlampir</span>

<br>
<span style='margin-left:2cm'>Demikian surat pengantar pindah ini dibuat agar dapat dipergunakan sebagaimana mestinya</span>
