...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Anak-Anak</title>
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    $query1="SELECT id,nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and  YEAR(curdate()) - YEAR(tgl_lahir) >= '6' and YEAR(curdate()) - YEAR(tgl_lahir) <= '11' and jk='L'" ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and  jk = 'L' and YEAR(curdate()) - YEAR(tgl_lahir) >= '6' and YEAR(curdate()) - YEAR(tgl_lahir) <= '11' ");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Kanak-Kanak Pria : <?php echo "$user"; ?> Orang </h4> </center>
