                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                    /*$query1="SELECT * FROM data_penduduk, data_migrasi WHERE data_penduduk.id = data_migrasi.id_migrasi and ket = 'hidup' and asal = 'pendatang'";*/
                    $no = 0;

                   $tampil=$conn->query("SELECT * from data_migrasi ");
                   
                    ?>
                    <table id="example" lass="table table-striped table-bordered nowrap" style="width:100%">
                  <thead>
                      <tr>
                          <th><B>No </B></th>
                        <th><B>NIK </B></th>
                    ...
                    <tr>
                        <td><?php echo $no ?></td>  
                    <td> <a href="detail-migrasi.php?hal=edit&kd=<?php echo $data['nik'];?>"><?php echo $data['nik']; ?></a></td>
                    <td><?php echo $data['nama'];?></td>
                    <td><?php echo $data['tgl_masuk'];?></td>
                    <td>RT/RW <?php echo $data['rtrw_asal']?>, Desa <?php echo $data['desa_asal']?>, Kecamatan <?php echo $data['kecamatan_asal']?>, Kabupaten <?php echo $data['kabupaten_asal']?></td>
                    ...
                    <?php $tampil=$conn->query("SELECT * from data_mutasi");
                             $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Migrasi : <?php echo $user ; ?> Orang </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                    <form action="laporan-migrasi.php" method="POST">
                 ...
                 <a class="btn btn-sm btn-success glyphicon glyphicon-print"><input type="submit" class="btn btn-sm btn-success" value="Laporan" title="Laporan Migrasi"></a><br><br>
                 <a href="input-migrasi.php" class="btn btn-sm btn-primary">Tambah data Migrasi<i class="fa fa-arrow-circle-down"></i></a>
             </form>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
