...
<head>
    <meta charset="UTF-8">
    <title>Input Data Kelahiran</title>
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-kelahiran.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="tempat_lahir" type="text" id="tempat_lahir" class="form-control" required placeholder="Tempat Lahir" />
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <input name="provinsi" class="form-control" id="kabupaten" type="text" placeholder="provinsi" required />
                              </div>
                              </div>
                              <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="no_kk" class="form-control" id="kk" type="text" placeholder="nomor kk" required />
                              </div>
                          </div>
                            <div class="form-group">
