...
<?php } ?>
 ...
 <b>Data Kematian</b>
                                ...
                                <div class="panel-body table-responsive">
                                   ...
                                   <?php
                    $query1="SELECT * from data_kematian";
                  ...
                  <thead>
                      ...
                      <tr>
                        <th><B>No </B></th>
                        <th><B>ID Kematian</B></th>
                        <th><B>Tanggal Kematian </B></th>
                        <th><B>Tempat Makam </B></th>
                        <th><B>Nama Pelapor </B></th>
                        <th><B>Nik Pelapor</B></th>
                        <th><B>Hubungan Pelapor</B></th>
                        <th><B>NIK Penduduk</B></th>
                      </tr>
                  </thead>
                    ...
                    <tr>
                        <td><?php echo $no ?></td>  
                    <td> <a href="detail-kematian.php?hal=edit&kd=<?php echo $data['id_kematian'];?>"><?php echo $data['id_kematian']; ?></a></td>
              ...
              ?>
                 ...
                 <?php $tampil=$conn->query("SELECT * from data_kematian");
                             $user=mysqli_num_rows($tampil);
                    ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                    <form action="laporan-kematian.php" method="POST">
                 ...
                 <a class="btn btn-sm btn-success glyphicon glyphicon-print"><input type="submit" class="btn btn-sm btn-success" value="Laporan" title="Laporan Kematian"></a><br><br>
