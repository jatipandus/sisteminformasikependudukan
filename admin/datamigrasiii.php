...
<?php } ?>
 ...
 <b>Data Kematian</b>
                                ...
                                <div class="panel-body table-responsive">
                                   ...
                                   <?php
                    //$query1="SELECT * from data_penduduk where asal = 'asli' and ket = 'hidup'";
                   ...
                   $tampil=$conn->query("SELECT * from data_penduduk, data_kematian where ket = 'mati'");
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>ID Kematian</center></th>
                        <th><center>Tanggal Kematian </center></th>
                        <th><center>Temmpat Makam </center></th>
                        <th><center>Nama Pelapor </center></th>
                        <th><center>Nik Pelapor</center></th>
                        <th><center>Hubungan Pelapor</center></th>
                        <th><center>ID Penduduk</center></th>
                    ...
                    <td><?php echo $data['id_penduduk'];?></td>

                    <td>
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="cetakkematian" href="suratmigrasi.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-print"></span></a><br>
              ...
              ?>
                 ...
                 <?php $tampil=$conn->query("SELECT * from data_penduduk where ket='mati' ");
                             $user=mysqli_num_rows($tampil);
                             
                    ?>
                                   
                  <center><h4>Jumlah Kematian : <?php echo "$user"; ?> Orang </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                 <!-- <a href="input-migrasi.php" class="btn btn-sm btn-primary">Tambah Migrasi <i class="fa fa-arrow-circle-down"></i></a>  -->
                 <a href="input-kematian.php" class="btn btn-sm btn-primary">Tambah data kematian <i class="fa fa-arrow-circle-down"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
