...
<head>
    <meta charset="UTF-8">
    <title>Data Penduduk Manula</title>
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    $query1="SELECT id,nik,nama,tempat_lahir,tgl_lahir,jk,alamat,agama,pekerjaan,status, YEAR(curdate()) - YEAR(tgl_lahir) AS usia FROM data_penduduk where ket = 'hidup' and asal !='pergi' and YEAR(curdate()) - YEAR(tgl_lahir) >= '66' and jk='P'" ; 
              ...
              ?>
                  ...
                  <?php $tampil=$conn->query("SELECT * from data_penduduk where ket = 'hidup' and asal != 'pergi' and jk = 'P' and YEAR(curdate()) - YEAR(tgl_lahir) >= '66' ");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Manula Wanita : <?php echo "$user"; ?> Orang </h4> </center>
