...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-kk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                     <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No KK</label>
                              <div class="col-sm-8">
                                  <input name="no_kk" type="text" id="no_kk" class="form-control" placeholder="masukan no kk" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="alamat" type="text" id="alamat" class="form-control"  placeholder="Nama Lengkap" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Desa/kelurahan</label>
                              <div class="col-sm-6">
                                  <input name="desakelurahan" type="text" id="desakelurahan" class="form-control"  placeholder="desa/kelurahan" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">rt/rw</label>
                              <div class="col-sm-6">
                                  <input name="rtrw" type="text" id="rtrw" class="form-control"  placeholder="rt/rw" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="kabupatenkota" type="text" id="kabupatenkota" class="form-control"  placeholder="kabupaten/kota" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode pos</label>
                              <div class="col-sm-6">
                                  <input name="kodepos" type="text" id="kodepos" class="form-control"  placeholder="kodepos" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <select class="form-control" name="jk" id="jk" value="laki-laki" readonly>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="tempat_lahir" class="form-control" id="tempat_lahir" type="text" placeholder="Alamat" required />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="jenis_pekerjaan" class="form-control" id="jenis_pekerjaan" type="text" placeholder="pekerjaan" required />
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                               ...
                               <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Statu hubungan dalam keluarga</label>
                              <div class="col-sm-4">
                           ...
                           <div class="form-group">
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="no_paspor" class="form-control" id="no_paspor" type="text" placeholder="isi tanda (-) jika tidak ada" required />
                              </div>
                          </div>
                               <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Kitas/Kitap</label>
                              <div class="col-sm-8">
                                  <input name="no_kitaskitap" class="form-control" id="no_kitaskitap" type="text" placeholder="isi tanda (-) jika tidak ada" required />
                              </div>
                          </div>
                          <div class="box-header"> 
                              ...
                              <div class="col-sm-8">
                                  <input name="ayah" class="form-control" id="ayah" type="text" placeholder="Nama Ayah" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Ibu</label>
                              <div class="col-sm-8">
                                  <input name="ibu" class="form-control" id="ibu" type="text" placeholder="Nama Ibu" required />
                              </div>
                          </div> 
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pekerjaan Ayah</label>
                              <div class="col-sm-8">
                                  <input name="pekerjaan_ayah" class="form-control" id="bu" type="text" placeholder="pekerjaan ayah" required />
                              </div>
                          </div> 
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pekerjaan Ibu</label>
                              <div class="col-sm-8">
                                  <input name="pekerjaan_ibu" class="form-control" id="bu" type="text" placeholder="pekerjaan Ibu" required />
                              </div>
                          </div> 
